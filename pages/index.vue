<template>
    <section class="flex iitems-center justify-between mb-10">
    ...
    <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 sm:gap-16 mb-10">
        ...
        <Trend color="red" title="Expense" :amount="expenseTotal" :last-amount="4000" :loading="isLoading" />
        <Trend color="red" title="Investments" :amount="2000" :last-amount="3000" :loading="isLoading" />
        <Trend color="green" title="Savings" :amount="4000" :last-amount="2000" :loading="isLoading" />
    </section>
    ...
    <section class="flex justify-between mb-10">
        ...
        <div>
            <UButton icon="i-heroicons-plus-circle" color="white" variat="solid" label="Add" @click="isOpen = true" />
